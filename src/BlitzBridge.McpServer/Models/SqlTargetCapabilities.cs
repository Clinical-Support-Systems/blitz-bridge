...
/// <summary>
/// Capability metadata for a configured SQL target profile.
/// </summary>
public sealed class SqlTargetCapabilities
{
    /// <summary>
    /// Profile name used to address the target.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether the target profile is enabled.
    /// </summary>
    ...
    /// <summary>
    /// Additional capability notes for operators and agents.
    /// </summary>
